...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        List<Vertice> menorCaminho = dijkstra.encontrarMenorCaminhoDijkstra(grafo, ac, rn);

        System.out.println("Menor caminho de " + ac.getNomeCidade() + " para " + rj.getNomeCidade() + ":");
